...
const CategoryPage = () => {
    ...
    const { data: category, loading: ctgrLoading } = useSingleData("category", ctgrId);
    const { posts, loading, handleSearch, refetchData, hasMore, photoName, photoId, ctgrName } = useContext(AllPostsContext);
            ...
            <div className="posts">
                <div className="container">
                    ...
                    <div className="posts__box">
                        ...
                        >
                            {loading ? <Loader /> : posts.map((post, i) => (post.category.name === name ? <PostsCard key={i} {...post} photoName={photoName} photoId={photoId} ctgrName={ctgrName} /> : null))}
                        </InfiniteScroll>
                    </div>
                </div>
            </div>
